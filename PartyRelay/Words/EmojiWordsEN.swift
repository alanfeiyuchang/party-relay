...
enum EmojiWordsEN {
    ...
    static let tier1: [String] = [
        ...
        "The Tortoise and the Hare", "Winnie the Pooh",
        // Everyday sayings
    ...
    static let tier2: [String] = [
        ...
        "The Lord of the Rings", "Avatar", "Back to the Future", "Home Alone", "The Matrix",
        "Jaws", "Ghostbusters", "Men in Black", "The Wizard of Oz", "Beauty and the Beast",
        "Up", "Ratatouille", "Monsters, Inc.", "Inside Out", "Coco",
        "Moana", "Encanto", "The Incredibles", "Wall-E", "Despicable Me",
        // TV
        "Friends", "Stranger Things", "Game of Thrones", "Breaking Bad", "The Office",
        "Sherlock", "The Simpsons", "Squid Game", "Black Mirror", "The Walking Dead",
        // Sayings
    ...
    static let tier3: [String] = [
        // Trickier films
        "The Godfather", "The Shawshank Redemption", "Forrest Gump", "The Silence of the Lambs",
        "Pulp Fiction", "Fight Club", "Inception", "Interstellar", "The Truman Show",
        "Groundhog Day", "The Sixth Sense", "Slumdog Millionaire", "The Devil Wears Prada",
        "Eternal Sunshine of the Spotless Mind", "Dead Poets Society",
        "La La Land", "Bohemian Rhapsody", "Mamma Mia!", "The Sound of Music", "Gone with the Wind",
        // Books, shows, anime
        "The Hunger Games", "The Da Vinci Code", "Sherlock Holmes", "Robinson Crusoe",
        ...
        "when it rains it pours", "the last straw",
    ]
}
